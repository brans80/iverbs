...
const levels = [
	{
		...
		name: 'dummy',
		amount: 3,
		descr: 'Уровень 0: (Дурачок) Вам предстоит пройти тест всего из 10 неправильных глаголов, которые будут сгенерированы из нулевой группы глаголов',
	},
	{
		level: 1,
		name: 'lazy ass',
		amount: 20,
		descr: 'Уровень 1: (Ленивая задница) Вам предстоит пройти тест из 20 неправильных глаголов, которые будут сгенерированы из нулевой группы глаголов',
	},
	{
		level: 2,
		name: 'schoolkid',
...
vars.verbsList = verbsList;
vars.levels = levels;
vars.verbForms = verbForms;
